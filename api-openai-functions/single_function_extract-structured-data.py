"""
use case 1 : extract structured data
Datacamp
"""
...
#############################################################
# example 1 : Get the job information from the body of the input text
...
def get_response_with_one_function(model, messages, function_definition):
...
print(get_response_with_one_function()(model, messages, function_definition))
# {"job":"Engineering Manager AI - Conversational AI","location":"Remote/ Germany"}


###################################################################
# example 2 : Get the information about homes for sale from the body of the input text
...
print(get_response_with_one_function()(
    model, message_listing, function_definition))

# {"home type": "single-family", "location": "Springfield, USA","price": 350000, "bedrooms": 4}

##################################################################
# example 3 : Extract the title and year of publication from research papers.
...
##############################################################
# example 4 : Extract sentiment and product features from reviews
